...
export default function PatientTabs({ activeTab, onTabChange }) {
  const tabs = [
    ...
    { 
      id: 'performance', 
      label: 'Statistiques',
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v4"></path><path d="M20 12h-4"></path><path d="M12 18v4"></path><path d="M4 12h4"></path><path d="M16 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"></path></svg>
    },
    { 
      id: 'notes', 
      label: 'Notes',
