...
export default function Relations() {
  ...
  // Mapping patient -> professionnels variés avec différentes spécialités
  const patientProfessionalsMap = {
    'pat-001': ['hp-001', 'hp-005', 'hp-007'], // Batman: Nutritionniste, Kiné, Psychologue
    'pat-002': ['hp-002', 'hp-005', 'hp-008'], // Deku: Diététicien, Kiné, Coach
    'pat-003': ['hp-003', 'hp-006', 'hp-008'], // Goku: Nutritionniste, Coach, Coach
    'pat-004': ['hp-004', 'hp-007'],           // Iron Man: Diététicien, Psychologue
    'pat-005': ['hp-001', 'hp-003'],           // Luffy: Nutritionnistes
    'pat-006': ['hp-002', 'hp-005', 'hp-006'], // Naruto: Diététicien, Kiné, Coach
    'pat-007': ['hp-007', 'hp-008'],           // Saitama: Psychologue, Coach
    'pat-008': ['hp-001', 'hp-005'],           // Spider-Man: Nutritionniste, Kiné
    'pat-009': ['hp-004', 'hp-006', 'hp-008'], // Thor: Diététicien, Coach, Coach
    'pat-010': ['hp-002', 'hp-005', 'hp-007'], // Wonder Woman: Diététicien, Kiné, Psychologue
  };
  ...
  const loadPatientProfessionals = async (patientId) => {
    try {
      ...
      const assignedProfessionalIds = patientProfessionalsMap[patientId] || ['hp-001', 'hp-002'];
      const patientProfessionals = allProfessionals.filter(pro =>
        assignedProfessionalIds.includes(pro.id)
      );
